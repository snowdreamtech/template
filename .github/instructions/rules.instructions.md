...
1. `.agent/rules/01-general.md` — Core principles (language, compatibility, security)
2. `.agent/rules/02-coding-style.md` — Coding conventions and commit standards
3. `.agent/rules/03-architecture.md` — Project structure and cross-platform patterns
